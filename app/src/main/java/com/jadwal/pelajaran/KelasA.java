...
public class KelasA extends AppCompatActivity implements AppBarLayout.OnOffsetChangedListener 
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        toolbarHeaderView.bindTo("Jadwal Pelajaran",16,"Kelas 9A",12,false);
        floatHeaderView.bindTo("Jadwal Pelajaran",30,"Kelas 9A",18,true);
    ...
    public List<Data> senin() {
        ...
        data.add(new Data("1","07:00 - 07:40","Pelajaran 1,A",0xffffffff,0xff008080));
