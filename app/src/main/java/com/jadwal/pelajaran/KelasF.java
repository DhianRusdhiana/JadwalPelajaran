...
public class KelasF extends AppCompatActivity implements AppBarLayout.OnOffsetChangedListener 
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        toolbarHeaderView.bindTo("Jadwal Pelajaran",16,"Kelas 9F",12,false);
        floatHeaderView.bindTo("Jadwal Pelajaran",30,"Kelas 9F",18,true);
        ...
        public Object instantiateItem(ViewGroup collection, int position) {
            ...
            switch(position){
                case 0:
                    ...
                    recyclerView.setLayoutManager(new LinearLayoutManager(KelasF.this));
                    break;
                case 1:
    ...
    private class MyPageChangeListener extends ViewPager.SimpleOnPageChangeListener {
        ...
        public void onPageSelected(int position) {
            Toast.makeText(KelasF.this,String.valueOf(position),Toast.LENGTH_SHORT).show();
