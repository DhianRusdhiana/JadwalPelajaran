...
public class KelasH extends AppCompatActivity implements AppBarLayout.OnOffsetChangedListener 
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        toolbarHeaderView.bindTo("Jadwal Pelajaran",16,"Kelas 9H",12,false);
        floatHeaderView.bindTo("Jadwal Pelajaran",30,"Kelas 9H",18,true);
        ...
        public Object instantiateItem(ViewGroup collection, int position) {
            ...
            switch(position){
                case 0:
                    ...
                    recyclerView.setLayoutManager(new LinearLayoutManager(KelasH.this));
                    break;
                case 1:
    ...
    private class MyPageChangeListener extends ViewPager.SimpleOnPageChangeListener {
        ...
        public void onPageSelected(int position) {
            Toast.makeText(KelasH.this,String.valueOf(position),Toast.LENGTH_SHORT).show();
