...
public class KelasE extends AppCompatActivity implements AppBarLayout.OnOffsetChangedListener 
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        toolbarHeaderView.bindTo("Jadwal Pelajaran",16,"Kelas 9E",12,false);
        floatHeaderView.bindTo("Jadwal Pelajaran",30,"Kelas 9E",18,true);
        ...
        public Object instantiateItem(ViewGroup collection, int position) {
            ...
            switch(position){
                case 0:
                    ...
                    recyclerView.setLayoutManager(new LinearLayoutManager(KelasE.this));
                    break;
                case 1:
    ...
    private class MyPageChangeListener extends ViewPager.SimpleOnPageChangeListener {
        ...
        public void onPageSelected(int position) {
            Toast.makeText(KelasE.this,String.valueOf(position),Toast.LENGTH_SHORT).show();
