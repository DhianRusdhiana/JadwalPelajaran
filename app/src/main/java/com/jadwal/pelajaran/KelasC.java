...
public class KelasC extends AppCompatActivity implements AppBarLayout.OnOffsetChangedListener 
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        toolbarHeaderView.bindTo("Jadwal Pelajaran",16,"Kelas 9C",12,false);
        floatHeaderView.bindTo("Jadwal Pelajaran",30,"Kelas 9C",18,true);
        ...
        public Object instantiateItem(ViewGroup collection, int position) {
            ...
            switch(position){
                case 0:
                    ...
                    recyclerView.setLayoutManager(new LinearLayoutManager(KelasC.this));
                    break;
                case 1:
    ...
    public List<Data> senin() {
        ...
        data.add(new Data("1","07:00 - 07:40","Pelajaran 1,C",0xffffffff,0xff008080));
    ...
    private class MyPageChangeListener extends ViewPager.SimpleOnPageChangeListener {
        ...
        public void onPageSelected(int position) {
            Toast.makeText(KelasC.this,String.valueOf(position),Toast.LENGTH_SHORT).show();
